...
export default function EditTeamMember({disabled = false}) {
    ...
    const [team, setTeam] = useState(row.team[0].toUpperCase() + row.team.slice(1))
    ...
    function editMember(){
        api.put(`/developer-team-members/${row.id}`,{"image": "./logo512.png",
        "name": name,
                ...
                <Grid item container justifyContent="center" className={teamStyle.editInputsContainer}>
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                        ...
                        <Grid item xs={12} sm={3} justifySelf="center">
                            <Typography className={teamStyle.responsiveText} variant="h6" textAlign={{xs:"start",...responsiveText}}>
                                Name
                            </Typography>
                        </Grid>
                        <Grid item xs={12} sm={9}>
                            <TextField className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} disabled={disabled} fullWidth id="fullWidth" value={name} onChange={e => setName(e.target.value)}/>
                        </Grid>
                    </Grid>
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                          className={teamStyle.inputsWrapper}>
                        ...
                        <Grid item xs={12} sm={9}>
                            <TextField className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} disabled={disabled} fullWidth id="fullWidth" value={email} onChange={e => setEmail(e.target.value)}/>
                        </Grid>
                    </Grid>
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                          className={teamStyle.inputsWrapper}>
                        ...
                        <Grid item xs={12} sm={9}>
                            <TextField className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} disabled={disabled} fullWidth id="fullWidth" value={experience}
                    ...
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                        ...
                        <Grid item xs={12} sm={9}>
                            <TextField className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} disabled={disabled} fullWidth id="fullWidth" value={phoneNumber}
                    ...
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                        ...
                        <Grid item xs={12} sm={9}>
                            <TextField className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} disabled={disabled} fullWidth id="fullWidth" value={occupation}
                    ...
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                        ...
                        <Grid item xs={12} sm={9}>
                            ...
                            <Select 
                                className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} 
                                disabled={disabled} 
                    ...
                    <Grid item container sm={8} justifyContent="start" alignItems="center" columnSpacing={3}
                        ...
                        <Grid item xs={12} sm={9}>
                            <TextField className={`${teamStyle.responsiveText} ${disabled ? teamStyle.disabled:''}`} disabled={disabled} fullWidth id="fullWidth" value={personalExperience} multiline rows={3}
                    ...
                    {!disabled ?
                        <Grid item container justifyContent="space-between" marginTop='20px'>
                            <Grid item>
                                <Button variant="contained" color="error" onClick={_ => api.delete(`/developer-team-members/${row.id}`)}>
                                    Delete
                                </Button>
                            </Grid>
                            <Grid item>
