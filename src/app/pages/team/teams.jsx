                        ...
                        <TableRow sx={{maxHeight: '100px'}} key={row.id}>
                            ...
                            <TableCell scope="row" className={teamStyle.actions}>
                                <IconButton
                                    ...
                                    aria-label="delete">
                                    <FontAwesomeIcon icon={faPenToSquare} className={teamStyle.edit}/>
                                </IconButton>
...
export default function Teams() {
    ...
    function handleTeamChange(e) {
        ...
        const filter = selectedTeam !== 'All' && rows.filter(person => person.team === selectedTeam)
        ...
        <Container maxWidth={false} className={teamStyle.teamContainer}>
            <Grid container justifyContent="space-between">
                <Grid item container xs={12} justifyContent="space-between">
                    <Grid item xs={6} sm={3} md={3} lg={3} xl={3} container direction={{xs:''}}>
                        {addingTeam ?
                            <>
                                <Grid item xs={10}>
                                ...
                                <Grid item xs={5}>
                                    <Button color={deleteTeam ? 'primary':'error'} onClick={_ => {setAddingTeam(false);setDeleteTeam(false)}}
                                            variant='contained'>Cancel</Button>
                                </Grid>
                                <Grid item xs={5} align='right'>
                                    <Button onClick={_ => AddTeam(true)} color={deleteTeam ? 'error':'primary'} variant='contained'>{deleteTeam ?"Delete":'Add'}</Button>
                                </Grid>
